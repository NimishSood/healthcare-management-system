    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
        ...
        <div className="text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">Manage your health records and appointments anytime, anywhere</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">Secure, HIPAA-compliant medical records management</p>
            </div>
          </div>

          {/* Provider Section */}
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Healthcare Providers</h2>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                to="/login?role=doctor"
                className="px-6 py-2 bg-sky-100 hover:bg-sky-200 text-sky-800 rounded-lg transition-colors"
              >
                Doctor Portal
              </Link>
              <Link
                to="/login?role=admin"
                className="px-6 py-2 bg-purple-100 hover:bg-purple-200 text-purple-800 rounded-lg transition-colors"
              >
                Admin Portal
              </Link>
              <Link
                to="/login?role=staff"
                className="px-6 py-2 bg-amber-100 hover:bg-amber-200 text-amber-800 rounded-lg transition-colors"
              >
                Staff Portal
              </Link>
            </div>
      ...
      <footer className="bg-white border-t border-gray-200 mt-20">
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 text-center text-sm text-gray-500">
          ...
          <div className="mt-2">
            <Link to="/privacy" className="hover:text-blue-600 mx-2">Privacy Policy</Link>
            <Link to="/terms" className="hover:text-blue-600 mx-2">Terms of Service</Link>
          </div>
        </div>
      </footer>
    </div>
